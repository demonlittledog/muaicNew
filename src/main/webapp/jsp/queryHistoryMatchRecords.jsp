...
<div class="formbody">
	<div id="usual1" class="usual">
		...
		<div id="tab1" class="tabson">
			<form action="${pageContext.request.contextPath}/queryHistoryMatchRecords.do" method="post" name="form4" id="form4">
				<ul class="seachform">
	...
	<div class="pagin">
		...
		<form action="${pageContext.request.contextPath }/queryHistoryMatchRecords.do" method="post">
		...
		<form action="quertyteacher.do" method="post">
			<ul class="paginList">
				<c:if test="${currentPageNo>1}">
					<li class="paginItem"><a href="${pageContext.request.contextPath }/queryHistoryMatchRecords.do?currentPageNo=1&pageSize=${param.pageSize}&matchClassName=${param.matchClassName}&studentName=${param.studentName}&da1=${requestScope.da1}&da2=${requestScope.da2}">首页</a></li>
					<li class="paginItem"><a href="${pageContext.request.contextPath }/queryHistoryMatchRecords.do?currentPageNo=${currentPageNo-1}&pageSize=${param.pageSize}&matchClassName=${param.matchClassName}&studentName=${param.studentName}&da1=${requestScope.da1}&da2=${requestScope.da2}" class="pia">上一页</a></li>
                </c:if>
                <c:if test="${currentPageNo<=1}">
				...
				<li class="paginItem"><a href="${pageContext.request.contextPath }/queryHistoryMatchRecords.do?currentPageNo=${currentPageNo+1}&pageSize=${param.pageSize}&matchClassName=${param.matchClassName}&studentName=${param.studentName}&da1=${requestScope.da1}&da2=${requestScope.da2}" class="pia">下一页</a></li>
				<li class="paginItem"><a href="${pageContext.request.contextPath }/queryHistoryMatchRecords.do?currentPageNo=${totalPageCount}&pageSize=${param.pageSize}&matchClassName=${param.matchClassName}&studentName=${param.studentName}&da1=${requestScope.da1}&da2=${requestScope.da2}">尾页</a></li>
				</c:if>
                <c:if test="${currentPageNo>=totalPageCount}">
