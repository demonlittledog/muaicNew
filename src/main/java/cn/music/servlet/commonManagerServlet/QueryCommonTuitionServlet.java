...
public class QueryCommonTuitionServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String,Object>> list = cts.getAllCommonTuition(currentPageNo,pageSize,da1,da2,commonClassName,studentName);

        //获得总页数
        int totalCount = cts.getAllCommonTuitionCount(da1,da2,commonClassName,studentName);
        ...
        req.getRequestDispatcher("jsp/queryCommonTuition.jsp").forward(req,resp);
    }
}
