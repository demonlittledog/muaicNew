...
<script type="text/javascript">
    ...
    function validateCommonClassName() {
        ...
        if(commonClassName==null || commonClassName.length==0){
            ...
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath }/checkCommonClassName.do",
                data:{"commonClassName":commonClassName},
                dataType:"text",
...
<div class="formbody">
    ...
    <form action="${pageContext.request.contextPath }/addCommonClassInfo.do" method="post" name="form7" id="form7">
        <ul class="forminfo">
            <li><label>普通班级名称</label><input type="text" name="commonClassName" id="commonClassName" class="dfinput" /><i><span id="scommonClassName"></span></i></li>
            <li><label>班级类型</label><select name="classTypeId" id="classTypeId" class="dfinput" style="width:200px;">
                <c:forEach items="${classTypeList}" var="classType">
                    <option <c:if test="${param.classTypeId==classType.classTypeId}">selected</c:if> value="${classType.classTypeId}">${classType.classTypeName}</option>
                </c:forEach>
            </select>
                <input type="button" value="增加普通班级类型" class="btn" onclick="addClassType()"><i></i></li>
            ...
            <li><label>课时费</label><input type="text" name="commonCost" id="commonCost" class="dfinput"><i><span id="scommonCost"></span></i></li>
            <li><label>总课程数</label><input type="text" name="commonSum" id="commonSum" class="dfinput"><i><span id="scommonSum"></span></i></li>
            <li><label>开班日期</label>
                <input type="date" name="commonClassDate" id="commonClassDate" class="dfinput">
            ...
            <li><label>上课时间</label><input type="time" name="commonTime" id="commonTime" class="dfinput"><i><span id="scommonTime"></span></i></li>
            <li><label>上课时长</label><input type="text" name="commonSpan" id="commonSpan" class="dfinput"><i><span id="scommonSpan"></span></i></li>
            <li><label>班级状态</label>
                <input type="radio" name="commonStatus" value="1" class="sex"  checked />正常
                <input type="radio" name="commonStatus" value="0"  style="margin-left:20px;" class="sex" />冻结
            </li>
            <li><label>&nbsp;</label>
