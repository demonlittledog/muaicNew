 ...
 */
public class QueryTeaCommonRecordsServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String,Object>> list = tcrs.getAllTeaCommonRecords(currentPageNo,pageSize,da1,da2,commonClassName,teaManName);

        //获得总页数
        int totalCount = tcrs.getTeaCommonRecordsCount(da1,da2,commonClassName,teaManName);
        ...
        req.getRequestDispatcher("jsp/queryTeaCommonRecords.jsp").forward(req,resp);
    }
