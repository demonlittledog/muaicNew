 ...
 */
public class QueryCommonRecordsServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String,Object>> list = crs.getAllCommonRecords(currentPageNo,pageSize,da1,da2,commonClassName,studentName);

        //获得总页数
        int totalCount = crs.getCommonRecordsCount(da1,da2,commonClassName,studentName);
        ...
        req.getRequestDispatcher("jsp/queryCommonRecords.jsp").forward(req,resp);
    }
}
