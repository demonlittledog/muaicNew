...
import cn.music.service.commonManagerService.MatchTuitionService;
...
public class QueryMatchTuitionServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String,Object>> list = mts.getAllMatchTuition(currentPageNo,pageSize,da1,da2,matchClassName,studentName);

        //获得总页数
        int totalCount = mts.getAllMatchTuitionCount(da1,da2,matchClassName,studentName);
        ...
        req.getRequestDispatcher("jsp/queryMatchTuition.jsp").forward(req,resp);
    }
}
