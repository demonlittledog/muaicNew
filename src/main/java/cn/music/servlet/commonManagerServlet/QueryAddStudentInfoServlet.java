...
public class QueryAddStudentInfoServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Map<String,Object>> list = sis.getStudentByTuition(currentPageNo,pageSize,commonClassId,studentName);

		//获得总页数
		int totalCount = sis.getStudentByTuitionCount(commonClassId,studentName);
		...
		req.getRequestDispatcher("jsp/addStudentToCommonClass.jsp").forward(req,resp);
	}
}
